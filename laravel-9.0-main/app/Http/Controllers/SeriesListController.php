...
class SeriesListController extends Controller
{
    ...
    public function list() {
        ...
        $s2 = (object)array("name" => "Squid Game", "image" => "image/squadgame.jpeg", "desc" => "It revolves around a secret contest where 456 players, all of whom are in deep financial hardship, risk their lives to play a series of deadly children's games.", "actor"=>"Lee Jung, Park Hae, Kim Joo", "director" => "Hwang Dong-hyuk");
    ...
    public function showList() {
        ...
        return view('seriesList', ['seriesList'=>$listaSerie]);
    }
}
